...
class App(QMainWindow,Ui_mainWindow):
    ...
    def get_points(self, event):
        ...
        k=pd.DataFrame(self.countArea)
        k.to_excel("Boundary Coordinate"+".xlsx")
        #x1=self.countArea.append(int(x*self.imgScale[1]))
        #y1= self.countArea.append(int(y*self.imgScale[0]))
    ...
    def start_count(self):
        if self.running_flag == 0:
            ...
            # clear result file
            with open("Final Summary.xlsx", "w") as f:
                pass
    ...
    def update_counter_results(self,counter_results):
        import datetime
        with open("Final Summary.xlsx", "a") as f:
